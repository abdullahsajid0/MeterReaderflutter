...
List<Uint8List> cropMeterImageVariants(
  ...
  if (source == null || source.width < 20 || source.height < 20) return [];
  ...
  final highContrast =
      img.adjustColor(grayscale, contrast: 1.7, brightness: 1.05);
  return [
    Uint8List.fromList(img.encodeJpg(enlarged, quality: 96)),
    Uint8List.fromList(img.encodeJpg(grayscale, quality: 96)),
    Uint8List.fromList(img.encodeJpg(highContrast, quality: 96)),
  ];
}
